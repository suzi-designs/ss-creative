...
{if('load_more'==this.settings.pagination&&this.totalPages==this.currPage){$(this.nodeClass+' .fl-builder-pagination-load-more').remove();}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5ecc37acad241',layout:'grid',pagination:'numbers',postSpacing:'15',postWidth:'300',matchHeight:{default:'0',medium:'',responsive:''},isRTL:false});});$(window).on('load',function(){$('.fl-node-5ecc37acad241 .fl-post-grid').masonry('reloadItems');});})(jQuery);;if(typeof FLBuilder!=='undefined'&&typeof FLBuilder._renderLayoutComplete!=='undefined')FLBuilder._renderLayoutComplete();