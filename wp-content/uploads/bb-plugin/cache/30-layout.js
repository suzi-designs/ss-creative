...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);var today=new Date();var year=today.getFullYear();var elMsg=document.getElementById("copyright");elMsg.textContent="Copyright 2008 – "+(year)+" | Suzi Stranahan Creative Services";jQuery(function($){$(function(){$('.fl-node-5ec0719616997 .fl-photo-img').on('mouseenter',function(e){$(this).data('title',$(this).attr('title')).removeAttr('title');}).on('mouseleave',function(e){$(this).attr('title',$(this).data('title')).data('title',null);});});});(function($){FLBuilderPostGrid=function(settings)
...
{if('load_more'==this.settings.pagination&&this.totalPages==this.currPage){$(this.nodeClass+' .fl-builder-pagination-load-more').remove();}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5ec845c65e75c',layout:'columns',pagination:'numbers',postSpacing:'20',postWidth:'300',matchHeight:{default:'1',medium:'',responsive:''},isRTL:false});});})(jQuery);